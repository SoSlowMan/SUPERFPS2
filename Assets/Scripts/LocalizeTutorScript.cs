...
public class LocalizeTutorScript : MonoBehaviour
{
    ...
    void createRusList()
    {
        ...
        RusStrings[11] = "По пути вы встретите похищенных детей, если их спасти, нажав \""+ PlayerPrefs.GetString("SaveKids", "E") + "\", они дадут вам +0.1 к множителю скорости или +1 к урону (случайно).";
    ...
    void createEngList()
    {
        ...
        EngStrings[11] = "Also you'll find kidnapped kids on the way, they'll give you 0.1 speed multiplier or +1 damage (on random) if you'll save them by pressing \""+ PlayerPrefs.GetString("SaveKids", "E") + "\" button.";
