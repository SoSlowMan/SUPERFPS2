...
public class LocalizeTutorScript : MonoBehaviour
{
    ...
    void createRusList()
    {
        ...
        RusStrings[7] = "Ваша задача в игре: найти самый быстрый путь к выходу и набрать как можно больше очков. Нажмите \"" + PlayerPrefs.GetString("Replay", "F") + "\" чтобы перезапустить уровень и \"" + PlayerPrefs.GetString("Exit", "Escape") + "\" чтобы выйти в главное меню.";
        ...
        RusStrings[11] = "По пути вы встретите похищенных детей, если их спасти, нажав \""+ PlayerPrefs.GetString("SaveKids", "E") + "\", синий даст вам +0.1 к множителю скорости, а красный +1 к урону.";
        ...
        RusStrings[15] = "Счет:";
        RusStrings[16] = "Нажмите \"" + PlayerPrefs.GetString("Exit", "Escape") + "\" чтобы вернуться в главное меню";
    }
    ...
    void createEngList()
    {
        ...
        EngStrings[7] = "Your task in this game is to find the fastest route to the end and to get huge amount of points. Also, press \"" + PlayerPrefs.GetString("Replay", "F") + "\" to restart level and \"" + PlayerPrefs.GetString("Exit", "Escape") + "\" to exit to the main menu.";
        ...
        EngStrings[11] = "Also you'll find kidnapped kids on the way, red ones will give you +0.1 speed multiplier, and red ones will give +1 damage if you'll save them by pressing \""+ PlayerPrefs.GetString("SaveKids", "E") + "\" button.";
        ...
        EngStrings[15] = "SCORE:";
        EngStrings[16] = "Press \"" + PlayerPrefs.GetString("Exit", "Escape") + "\" to get back to the Main Menu";
